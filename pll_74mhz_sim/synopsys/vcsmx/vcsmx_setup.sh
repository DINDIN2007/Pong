...
# ACDS 24.1 1077 linux 2025.10.02.18:05:23
...
TOP_LEVEL_NAME="pll_74mhz"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/dinhv/intelFPGA_lite/24.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_74mhz.vho"
fi
